          ...
          rel="noopener noreferrer"
              ...
              >
                <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12.6.75h-.733c-1.465 0-2.93.123-4.358.365l-.109.02A11.49 11.49 0 0 0 6.118 1.5l-.085.02c-1.37.338-2.75.736-4.042 1.243l-.162.064a.752.752 0 0 0-.43.845l3.429 14.141c.097.403.51.637.913.54l.153-.048a31.597 31.597 0 0 1 3.657-1.014l.101-.023c1.343-.305 2.698-.54 4.062-.71l.107-.012c1.416-.177 2.842-.266 4.267-.266h.733c1.465 0 2.93.123 4.358.365l.109.02c.44.088.878.186 1.315.294l.085.02c1.37.339 2.75.736 4.042 1.243l.162.064c.405.16.854-.039 1.014-.444.03-.076.045-.157.045-.239V3.34a.752.752 0 0 0-.43-.845l-.162-.064a31.597 31.597 0 0 0-4.042-1.243l-.085-.02a11.49 11.49 0 0 0-1.315-.294l-.109-.02A23.89 23.89 0 0 0 12.6.75Z"/>
                </svg>
              </a>
            </div>
          </div>
